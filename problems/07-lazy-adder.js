/***********************************************************************
Write a function named: lazyAdder(firstNum).

The lazyAdder function will:
accept a number and return a function.

When the function returned by lazyAdder
...
const lazyAdder = (firstNum) => {
 return secondAdder = (secondNum) => {
  return thirdAdder = (thirdNum) => {
